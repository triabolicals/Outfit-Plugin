...
pub fn get_result_color(result: AssetTable_Result, idx: usize) -> engage_il2cpp::unity_engine::Color {
    match idx {
...
pub fn try_find_accessory_model(result: AssetTable_Result, search_model: &str) -> Option<String> {
    result.m_accessories().items().iter().filter_map(|a| crate::il2str(a.get_model()))
